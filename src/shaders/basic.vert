...
void main()
{
    ...
    mat4 returnFig = mat4(vec4(1,0,0,0), vec4(0,1,0,0), vec4(0,0,1,0), vec4(centerPosition[0],centerPosition[1],centerPosition[2]-10,1));
    
    mat4 centerFig = mat4(vec4(1,0,0,0), vec4(0,1,0,0), vec4(0,0,1,0), vec4(-centerPosition[0],-centerPosition[1],-centerPosition[2]+10,1));
